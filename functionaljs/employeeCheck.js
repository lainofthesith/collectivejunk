...
var males = employees.filter(function(employee) {
  return employee.gender === 'M'
})
var maleAges = males.map(function(male) {
  return male.age
})
var maleAgeTotal = maleAges.reduce(function(acc, age) {
  return acc + age
})
var maleAgeAverage = maleAgeTotal / males.length
...
var females = employees.filter(function(employee) {
  return employee.gender === 'F'
})
var femaleAges = females.map(function(female) {
  return female.age
})
var femaleAgeTotal = femaleAges.reduce(function(acc, age) {
  return acc + age
})
femaleAgeAverage = femaleAgeTotal / females.length
